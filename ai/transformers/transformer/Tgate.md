...
## 1. I. 확산 모델 추론 과정의 연산 비효율성과 어텐션 메커니즘
...
## 2. II. 어텐션의 시간적 역할 분화: Tgate의 핵심 관찰
...
## 3. III. Tgate (Temporally Gating the Attention)의 구조와 작동 원리
...
## 5. V. Tgate의 실용적 함의, 한계 및 미래 연구 방향
...
## 6. VI. 결론: 시간적 어텐션 분해를 통한 확산 모델의 새로운 지평
