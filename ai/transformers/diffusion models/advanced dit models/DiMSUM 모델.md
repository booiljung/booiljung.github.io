...
### 2.2 상태 공간 모델(SSM)의 부상: 효율적인 후계자 맘바
...
## 3. 아키텍처 심층 분석: DiMSUM 프레임워크의 작동 원리
...
#### 3.3.2 교차-어텐션 융합 레이어 (Cross-Attention Fusion Layer)
...
#### 3.3.3 전역 공유 트랜스포머 블록 (Globally-Shared Transformer Block)
...
## 5. 비판적 고찰: 동료 심사(OpenReview)에서의 논쟁
...
### 5.5 비판 5: "확장 가능(Scalable)"이라는 제목의 타당성
...
## 6. 결론: 생성 AI 분야에서 DiMSUM의 위상과 미래
