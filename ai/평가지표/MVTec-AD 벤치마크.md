...
## 1. 서론: 산업 이상 탐지 벤치마크의 표준, MVTec-AD
...
## 1.  MVTec-AD의 구조와 설계 철학: 통제된 환경의 정밀한 재현
...
## 2.  주요 이상 탐지 방법론의 계보와 분석: 재구성에서 임베딩으로의 패러다임 전환
...
### 2.4 표 1: MVTec-AD SOTA 모델 성능 비교 분석
...
## 3.  평가 지표의 다각적 분석과 한계: AUROC를 넘어 PRO까지
...
## 4.  벤치마크의 현재적 의의와 비판적 고찰: 'MVTec-AD에 대한 과적합' 문제
