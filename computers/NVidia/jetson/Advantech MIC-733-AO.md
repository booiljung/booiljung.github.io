...
## 1. 엣지 AI 컴퓨팅의 현황과 MIC-733-AO의 포지셔닝
...
## 2.  핵심 연산 아키텍처 분석: NVIDIA Jetson AGX Orin
...
### 5.1 TOPS 수치의 실체와 MLPerf 벤치마크 분석
...
### 5.2 엣지 생성형 AI (Edge GenAI) 구동 능력
