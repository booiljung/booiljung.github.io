...
## 1. II. 행동 트리의 핵심 원리 및 BehaviorTree.CPP 라이브러리
...
## 2. III. BehaviorTree.ROS2: ROS2 생태계와의 완벽한 통합
...
## 3. IV. 실제 적용 사례 연구: Nav2 내비게이션 스택
...
## 4. V. 기술 비교 분석: BehaviorTree.ROS2 vs. SMACH
