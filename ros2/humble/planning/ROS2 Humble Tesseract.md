...
## 1.  산업용 모션 플래닝의 새로운 지평, Tesseract
...
## 3.  충돌 검사의 정교함: 이산(Discrete) 대 연속(Continuous) 검사
...
## 6.  산업 현장에서의 적용: Tesseract 활용 사례 연구
...
### 7.2  각 프레임워크의 강점 및 적합한 적용 분야 분석
