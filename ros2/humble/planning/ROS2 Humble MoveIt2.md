...
## 2.  모션 플래닝 파이프라인 심층 비교: OMPL, STOMP, CHOMP
...
### 3.2  충돌 검사(Collision Checking) 라이브러리: FCL 대 Bullet
...
### 5.2  `ros2_control` 연동: 하드웨어 추상화의 핵심
...
### 6.1  타 프레임워크와의 비교: Tesseract 및 Drake
