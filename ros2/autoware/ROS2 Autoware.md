...
### 1.1  자율주행 오픈소스의 필요성과 Autoware의 등장
...
## 2.  Autoware의 진화: 기술적 부채 극복과 새로운 아키텍처의 탄생
...
### 2.1  Autoware.AI (ROS1): 위대한 시작과 기술적 부채
...
### 2.2  Autoware.Auto (ROS2): 품질과 안전을 향한 첫걸음
...
### 2.3  Autoware Core/Universe: 안정성과 혁신의 공존을 위한 "마이크로 아키텍처"
...
## 3.  Autoware 아키텍처 심층 분석: 6대 핵심 스택
...
### 3.2  Localization (위치 추정): "나는 지금 어디에 있는가?"
...
#### 3.2.1 핵심 알고리즘 1: NDT (Normal Distributions Transform)
...
#### 3.2.2 핵심 알고리즘 2: EKF (Extended Kalman Filter) 기반 센서 융합
...
### 3.3  Perception (인지): "내 주변에 무엇이 있는가?"
...
### 3.4  Planning (경로 계획): "어디로, 어떻게 갈 것인가?"
...
#### 3.4.1 Mission/Behavior Planning (전역/행동 계획)
...
#### 3.4.2 Motion Planning (지역/동작 계획)
...
#### 3.5.2 핵심 알고리즘 2: MPC (Model Predictive Control)
