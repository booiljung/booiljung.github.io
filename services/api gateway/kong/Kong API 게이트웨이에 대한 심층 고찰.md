...
## 서론: 마이크로서비스 시대의 관문, API 게이트웨이와 Kong의 역할
...
## 1.  Kong의 근간: Nginx, OpenResty, 그리고 Lua
...
#### 3.2.3 범위(Scope)와 우선순위(Precedence)
...
### 5.2  서비스 메시와의 통합: Kuma와 Kong Mesh
...
### 6.2  기능, 아키텍처, 가격 모델, 개발자 경험 관점에서의 비교 분석
