...
## 1.  라이다 SLAM 기술의 진화와 핵심 패러다임

### 1.1 A. SLAM의 근본 문제와 라이다의 역할
...
## 2.  LOAM: 특징 기반 라이다 SLAM의 초석 (2014)

### 2.1 A. 발표 정보 및 학술적 의의
...
## 3.  LeGO-LOAM: 경량화 및 지면 최적화를 통한 진화 (2018)
...
## 4.  LIO-SAM: 팩터 그래프 기반의 강건한 다중 센서 융합 (2020)
...
### 4.3 C. 기술적 특징: 슬라이딩 윈도우와 키프레임 관리
...
## 5.  FAST-LIO & FAST-LIO2: 칼만 필터 기반 고속-강건 SLAM (2021)

### 5.1 A. 기술적 참고 관계 및 발표 정보
...
### 5.2 B. 핵심 방법론 (FAST-LIO): 계산 효율적인 iEKF
...
### 5.3 C. 혁신 (FAST-LIO2): 직접 정합과 ikd-Tree
...
## 7.  결론 및 미래 전망: 딥러닝과 새로운 센서의 도전

### 7.1 A. 딥러닝 기반 SLAM의 부상
