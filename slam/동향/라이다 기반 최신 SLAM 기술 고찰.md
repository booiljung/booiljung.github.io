...
## 1.  LOAM: 특징 기반 라이다 SLAM의 초석 (2014)
...
## 2.  LeGO-LOAM: 경량화 및 지면 최적화를 통한 진화 (2018)
...
## 3.  LIO-SAM: 팩터 그래프 기반의 강건한 다중 센서 융합 (2020)
...
### 3.3 C. 기술적 특징: 슬라이딩 윈도우와 키프레임 관리
...
## 4.  FAST-LIO & FAST-LIO2: 칼만 필터 기반 고속-강건 SLAM (2021)
