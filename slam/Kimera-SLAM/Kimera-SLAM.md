...
### 1.3  Kimera-RPGO & PGMO: 강인한 포즈 그래프 최적화 (Robust Pose Graph Optimization)
...
#### 2.2.3 사전적분된 측정값 (Preintegrated Measurements)
...
#### 2.3.3 이상치 강인성 (Outlier Robustness)
