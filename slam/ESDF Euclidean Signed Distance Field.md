...
### 1.3  부호 거리 필드(SDF)의 개념과 본 보고서의 범위
...
### 2.1  ESDF의 정규 정의 (Formal Definition)
...
### 2.3  거리 메트릭(Distance Metric)에 대한 고찰
...
### 3.2  동적 환경을 위한 점진적(Incremental) 생성 기법
...
### 5.1  ESDF 대 TSDF (Truncated Signed Distance Field)
