# ID-LIO와 RF-LIO의 비교 고찰: 동적 환경 LiDAR-Inertial Odometry의 두 가지 접근법

## I. 서론: 동적 환경 LIO의 도전과 공통 기반 LIO-SAM
...
## 1. II. RF-LIO: '선-제거(Removal-First)' 패러다임의 심층 분석
...
## 2. III. ID-LIO: '인덱스 포인트와 지연된 제거' 전략 탐구
...
#### 2.3.1  공간적 탐지: Pseudo Occupancy Grid
...
## 3. IV. 핵심 전략 비교 분석: RF-LIO 대 ID-LIO
...
### 5.1  적용 분야 및 연구 목적에 따른 선택 가이드라인
