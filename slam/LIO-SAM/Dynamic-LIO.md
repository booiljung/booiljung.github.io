...
## 1.  동적 환경 SLAM의 난제와 LIO 프레임워크의 진화

### 1.1 A. 문제 정의: 정적 세계 가정의 붕괴
...
### 1.2 B. 해결을 위한 접근법: 동적 객체 필터링 기법의 분류
...
### 1.3 C. LIO 프레임워크의 발전: Tightly-coupled 방식의 부상
...
### 2.2 B. 핵심 기술: 레이블 일관성 탐지 (Label Consistency Detection)
...
### 3.1 A. 프론트엔드: SR-LIO와 스윕 재구성 (Sweep Reconstruction)
...
### 3.2 B. 백엔드: SC-A-LOAM과 Scan Context
...
### 4.1 A. 정량적 성능 평가 (Quantitative Performance Evaluation)
