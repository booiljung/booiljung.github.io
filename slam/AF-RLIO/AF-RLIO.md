...
## 1.  AF-RLIO의 본질: 열악한 환경에서의 강건한 주행 거리 측정
...
## 2.  시스템 아키텍처 분석: 적응형 다중 센서 융합 프레임워크
...
### 3.2  LIO/SLAM에서의 '앵커'의 의미: 키프레임과 랜드마크
