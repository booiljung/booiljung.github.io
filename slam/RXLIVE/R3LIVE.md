...
### 0.3  기술적 진화: R2LIVE에서 R3LIVE, 그리고 R3LIVE++로
...
### 1.2  LiDAR-Inertial Odometry (LIO) 서브시스템: 기하학적 뼈대의 구축
...
#### 2.1.3  측정 모델 및 비용 함수 (Measurement Model and Cost Function)
...
### 4.2  R3LIVE vs. LIO-SAM: 필터 vs. 최적화
