...
## 1.  차세대 로보틱스를 위한 LiDAR-관성 주행계(LIO)의 기술적 과제
...
### 2.2 B. 강인한 상태 추정의 핵심: 반복 오류 상태 칼만 스무더(ESKS)
...
### 2.3 C. 실시간 성능을 위한 맵 구조: 로보센트릭 복셀 맵(RC-Vox)
...
## 3.  LIO 기술 지형도: FR-LIO와 주요 SOTA 시스템 비교 분석
...
### 3.3 C. 핵심 데이터 구조 심층 비교: ikd-Tree vs. iVox vs. RC-Vox
