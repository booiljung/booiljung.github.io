...
## 1. 칼만 필터의 한계와 확장 칼만 필터의 탄생

### 1.1 되짚어보기: 선형 칼만 필터(KF)의 완벽한 세계
...
### 1.2 현실의 벽: 비선형성이 가우시안 분포를 파괴할 때
...
### 1.3 EKF의 접근법: '순간의' 선형성으로 비선형을 길들이다
...
## 2. EKF의 수학적 심장: 자코비안 행렬

### 2.1 비선형 함수를 선형으로 근사하는 마법, 테일러 급수
...
### 2.3 선형 KF의 A, H를 대체하는 동적 행렬 F, H
