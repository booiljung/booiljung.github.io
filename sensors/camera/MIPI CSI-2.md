...
### 1.1 A. MIPI Alliance의 비전과 표준화 목표
...
### 1.3 C. CSI-1에서 CSI-2 v4.1까지의 기술적 발전사
...
### 2.1 A. 다계층 프로토콜 스택의 구조와 각 계층의 기능
...
### 2.2 B. 애플리케이션 계층에서 물리 계층까지의 데이터 흐름
...
### 3.3 C. A-PHY: 자동차 환경을 위한 장거리 SerDes
...
### 3.4 D. 핵심 테이블 1: PHY 기술 비교 분석 (D-PHY vs. C-PHY vs. A-PHY)
...
### 4.1 A. 패킷 구조: Short/Long Packet의 필드별 상세 해부
...
### 4.2 B. 가상 채널(Virtual Channel)을 이용한 다중 스트림 처리 기술
...
### 4.3 C. 데이터 타입(RAW, YUV, RGB)과 픽셀-바이트 변환 메커니즘
...
### 4.4 D. 핵심 테이블 2: 데이터 포맷별 픽셀-바이트 패킹 규칙
...
### 5.1 A. 모바일 혁신을 넘어: 자동차, IoT, 드론, 의료 영상으로의 확장
...
### 5.2 B. 주요 SoC에서의 MIPI CSI-2 인터페이스 구현 동향
...
### 5.3 C. 인터페이스 기술 비교: MIPI CSI-2 vs. 병렬 인터페이스 vs. LVDS
...
### 6.1 A. 신호 무결성을 위한 PCB 레이아웃 설계 가이드
...
### 6.2 B. 일반적인 디버깅 문제 유형 및 단계별 해결 전략
...
### 7.1 A. SROI, AOSC 등 최신 기능의 기술적 원리와 응용 가치
...
### 7.2 B. MIPI Alliance의 기술 로드맵과 차세대 비전 시스템의 미래
...
40. MIPI CSI-2 Virtual Channel Aggregation Reference Design - Lattice Semiconductor, 8월 14, 2025에 액세스, https://www.latticesemi.com/en/Products/DesignSoftwareAndIP/IntellectualProperty/ReferenceDesigns/ReferenceDesign04/Nto1
41. How you can log sensor data using MIPI® CSI-2 port replication in ADAS application - Texas Instruments, 8월 14, 2025에 액세스, https://www.ti.com/lit/pdf/ssztar4
42. YouMIPI-Brite Semiconductor (Shanghai) Co., Ltd - 灿芯半导体, 8월 14, 2025에 액세스, https://www.britesemi.com/en/YouIP/YouMIPI.htm
43. MIPI CSI-2 Intel® FPGA IP User Guide, 8월 14, 2025에 액세스, https://cdrdv2-public.intel.com/833938/ug-813926-833938.pdf
44. What is Intelligent Photography? Part III: Understanding Different Image File Formats and the Mysterious YUV - Edge AI and Vision Alliance, 8월 14, 2025에 액세스, https://www.edge-ai-vision.com/2021/05/what-is-intelligent-photography-part-iii-understanding-different-image-file-formats-and-the-mysterious-yuv/
45. MIPI CSI2 TX-RX with MPSoC FPGA - LogicTronix, 8월 14, 2025에 액세스, https://logictronix.com/our-resources/case-studies/mipi-csi2-tx-rx-with-mpsoc-fpga/
46. 5.2. MIPI CSI-2 Transmitter - Intel, 8월 14, 2025에 액세스, https://www.intel.com/content/www/us/en/docs/programmable/813926/24-2-1-2-0/mipi-csi-2-transmitter.html
47. MIPI CSI-2 Intel® FPGA IP User Guide, 8월 14, 2025에 액세스, https://cdrdv2-public.intel.com/825390/ug-813926-825390.pdf
48. RAW10 Format Input Data to 16/24-bit Output in CX3 MIPI CSI-2, 8월 14, 2025에 액세스, https://community.infineon.com/t5/Knowledge-Base-Articles/Streaming-RAW10-Format-Input-Data-to-16-24-bit-Output-Format-in-CX3-MIPI-CSI-2/ta-p/259142
49. Mipi 인터페이스, 프로토콜 및 표준을 이해: 포괄적인 가이드 - Sinoseen, 8월 14, 2025에 액세스, https://www.sinoseen.com/ko/what-is-mipi-protocol-and-standards
...
56. Advanced driver assistance systems (ADAS) design resources | TI.com - Texas Instruments, 8월 14, 2025에 액세스, https://www.ti.com/applications/automotive/adas/overview.html
57. MIPI* CSI-2 Camera Interconnect - 004 - ID:655258 | Core™ Processors, 8월 14, 2025에 액세스, https://edc.intel.com/content/www/us/en/design/ipla/software-development-platforms/client/platforms/alder-lake-desktop/12th-generation-intel-core-processors-datasheet-volume-1-of-2/004/mipi-csi-2-camera-interconnect/
...
66. MIPI Physical Layer Routing and Signal Integrity | PCB Design Blog - Altium Resources, 8월 14, 2025에 액세스, https://resources.altium.com/p/mipi-physical-layer-routing-and-signal-integrity
...
68. Debug steps for customer MIPI sensor.docx - NXP Community, 8월 14, 2025에 액세스, [https://community.nxp.com/pwmxy87654/attachments/pwmxy87654/imx-processors/16825/1/Debug%20steps%20for%20customer%20MIPI%20sensor.docx](https://community.nxp.com/pwmxy87654/attachments/pwmxy87654/imx-processors/16825/1/Debug steps for customer MIPI sensor.docx)
...
70. Debugging CSI Capture Errors | NVIDIA Docs, 8월 14, 2025에 액세스, https://developer.nvidia.com/docs/drive/drive-os/6.0.7/public/drive-os-linux-sdk/common/topics/nvmedia_debugging_csi_errors/DebuggingNvMediaCSICaptureErrors1.html
...
73. MIPI DevCon 2021: The MIPI Specification Roadmap: Driving Advancements in Mobile, IoT, Automotive and 5G | PDF | Smartphones | Consumer Electronics - SlideShare, 8월 14, 2025에 액세스, https://www.slideshare.net/slideshow/mipi-devcon-2021-the-mipi-specification-roadmap-driving-advancements-in-mobile-iot-automotive-and-5g/250351244
