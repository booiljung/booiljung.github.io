...
## 1.  자율주행 시스템에서의 다중 센서 정합의 필연성

### 1.1 자율주행 인지 시스템의 복잡성과 다중 센서 융합의 중요성
...
### 1.2 외인성 캘리브레이션(Extrinsic Calibration)의 정의와 그 정확성이 시스템 전체에 미치는 영향
...
### 1.4 Multi-LiCa의 등장 배경: 비정형적 센서 구성의 난제
...
## 2.  Multi-LiCa 프레임워크 심층 분석

### 2.1 Multi-LiCa의 핵심 철학: 자동화된 모션리스(Motionless) 및 타겟리스(Targetless) 접근법
...
### 2.3 다중 LiDAR 처리를 위한 비용 기반 매칭 및 병합 전략
...
### 3.2 지역적 기하학 특징 추출: FPFH (Fast Point Feature Histograms)
...
### 5.1 문제 정의: 비중첩 시야(Non-overlapping FOV)
...
### 6.3 부가 기능: LiDAR-to-Ground 캘리브레이션
