...
## 1. 차세대 ADAS를 위한 양산형 라이다, Livox HAP의 등장
...
## 2.  핵심 기술: 비반복 스캐닝(Non-Repetitive Scanning)의 심층 분석
...
### 2.2  누적 시간(Integration Time)과 FOV 커버리지
