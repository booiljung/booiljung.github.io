...
### 1.2 선행 기술: 점 특징 히스토그램 (PFH, Point Feature Histogram)
...
### 2.2 단계: 이웃 SPFH의 가중치 합산을 통한 FPFH 구성
...
#### 2.3.1 Table 1: PFH vs. FPFH 비교 분석
...
#### 3.2.1 Table 2: FPFH 구현을 위한 핵심 파라미터 가이드
...
### 5.1 패러다임의 전환: Hand-crafted vs. Learned Descriptors
...
#### 5.2.1 Table 3: 3D 지역 특징 기술자 성능 벤치마크 (3DMatch)
