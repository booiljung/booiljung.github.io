...
### 1.3  대용량 데이터 시대의 도전 과제: 병렬 처리 및 캐시 효율성
...
### 1.4  고차원 데이터의 난제: '차원의 저주(Curse of Dimensionality)'
...
### 2.1  설계 목표: 작업, 스팬, 캐시 복잡도의 동시 최적화
...
#### 2.2.1  스켈레톤(Skeleton) 구축: 연산의 지역화
...
#### 2.2.2  체질(Sieving) 프로세스: 데이터 이동의 일괄 처리
...
#### 3.1.2  업데이트 알고리즘의 상각(Amortized) 복잡도
...
## 5.  고차원 데이터 색인을 위한 대안적 접근: PCA-tree
...
### 5.1  축-정렬 분할의 한계와 주성분 방향(Principal Direction)
...
### 5.3  Pkd-tree와의 비교: 내재적 차원(Intrinsic Dimension) 적응성
