...
### 1.3  동적 업데이트의 근본적 문제: 불균형과 성능 저하
...
### 2.2  확률적 균형 기법: 무작위 k-d 트리 (Randomized k-d Trees)
...
### 3.4 Table 1: 주요 공간 분할 자료구조 특성 비교
...
### 4.2  PIM-k-d-트리 (Processing-in-Memory)
