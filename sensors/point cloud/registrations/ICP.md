...
## 2.  고전적 ICP의 수학적 원리: Point-to-Point
...
### 3.1  Point-to-Plane ICP: 수렴 속도와 정확성의 향상
...
### 3.2  Generalized-ICP (G-ICP): 확률론적 통합 프레임워크
...
### 5.1  Coarse-to-Fine 패러다임: 전역에서 지역으로
