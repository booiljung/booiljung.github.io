...
### 1.2  Point-to-Plane ICP: 오차 측정 방식의 개선과 수렴 속도 향상
...
### 3.2  주요 파라미터 튜닝 전략 및 성능에 미치는 영향
...
### 3.3  `fast_gicp` 및 `small_gicp` 등 최적화된 라이브러리 소개
...
### 4.1  GICP 대 Point-to-Plane ICP: 강건성 및 정확도 비교
