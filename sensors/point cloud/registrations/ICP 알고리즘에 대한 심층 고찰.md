# Iterative Closest Point (ICP) 알고리즘에 대한 심층 고찰

## I. 서론: 점군 정합 문제와 ICP의 탄생
...
## 1. II. 고전적 ICP의 수학적 원리: Point-to-Point
...
## 4. V. 한계 극복을 위한 전략: 전역 정합과 강인한 추정
