...
## 1.  포인트 클라우드 정합의 본질과 ICP의 재발견

### 1.1  3D 공간 인지를 위한 핵심 과제: 포인트 클라우드 정합
...
### 2.2  수학적 원리 탐구: Point-to-Point vs. Point-to-Plane
...
### 3.1  "Keep It Small and Simple" 철학의 구현
...
#### 3.2.1  1차 방어: IMU-Free 모션 보상 (Scan De-skewing)
...
#### 3.2.2  2차 방어: 계층적 복셀 부표본화 (Hierarchical Voxel Subsampling)
...
#### 3.2.3  3차 방어: 적응형 임계값 (Adaptive Thresholding)
...
#### 3.2.4  4차 방어: 강건한 커널 (Robust Kernel)
...
### 4.2  강건한 비용 함수 (Robust Cost Function)
...
### 4.3  최적화: 반복적 재가중 최소제곱 (Iteratively Reweighted Least Squares, IRLS)
...
## 5.  비교 분석: KISS-ICP vs. G-ICP vs. NDT
