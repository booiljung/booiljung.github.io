...
## 1.  'iVox-PHC'의 정의와 기술적 맥락

### 1.1  용어의 명확화: 기술적 데이터 구조로서의 iVox-PHC
...
## 3.  주요 포인트 클라우드 데이터 구조와의 성능 비교 평가
...
### 3.1  대 k-d 트리 (ikd-Tree): 해싱 대 트리 분할
...
## 4.  iVox-PHC의 응용 및 실제적 고려사항

### 4.1  LiDAR SLAM 시스템에서의 활용 사례
