...
### 3.2  유효 XML (Valid XML): 구조적 약속의 준수
...
### 3.3  구조 정의 언어: DTD vs. XML 스키마(XSD)
...
### 4.2  데이터 변환의 마법: XSLT (eXtensible Stylesheet Language Transformations)
...
### 4.3  강력한 데이터 질의: XQuery (XML Query Language)
...
### 4.4  XML 처리의 두 가지 접근법: DOM vs. SAX
...
## 5.  현대 개발 환경에서의 XML - JSON과의 비교를 중심으로
...
### 5.3  보안 관점에서의 비교: XXE vs. Injection
