# NVIDIA Omniverse 플랫폼에 대한 분석 보고서: 아키텍처, 워크플로우 및 생태계
...
graph TD
    ...
    style "On-Premises Deployment" fill:#E1D5E7,stroke:#9673A6
    style "Omniverse Cloud (PaaS)" fill:#D5E8D4,stroke:#82B366
```
