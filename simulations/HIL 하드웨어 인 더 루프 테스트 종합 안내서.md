...
## 2. 제1장 테스트의 진화: 작업대에서 가상 세계로

### 2.1  고전적 접근법: 수동 및 자동화 테스트
...
### 5.3  복잡성 다루기: 네트워크 및 다중 ECU 시스템 테스트
