...
### 3.1  F-35의 '두뇌' 정의: 공통/통합 코어 프로세서(CIP/ICP)
...
### 4.1  하드웨어 기반: COTS 멀티코어 프로세서와 열관리 시스템
...
### 4.2  운영체제: Green Hills INTEGRITY-178B - 신뢰의 초석
...
### 4.3  소프트웨어 프레임워크: ARINC 653 - 애플리케이션의 헌법
...
### 5.4  네트워크 요새 강화: IMA 환경에서의 사이버 보안
...
### 6.1  소프트웨어 정의 항공기: 능력 개발의 새로운 논리
...
### 6.2  다음 개척지: 인공지능, 자율성, 그리고 설명가능성(XAI)
...
### 6.3  전투기를 위한 '앱 스토어': 진화하는 비즈니스 및 획득 모델
