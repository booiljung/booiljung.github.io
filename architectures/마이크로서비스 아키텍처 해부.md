...
### 1.3 도메인 주도 설계(DDD)를 통한 서비스 경계 설정
...
### 4.4 이벤트 소싱(Event Sourcing) 패턴: 불변의 이벤트 로그를 통한 진실의 원천
...
41. MSA란? ② 장점과 단점 - 메타넷글로벌, accessed July 13, 2025, https://metanetglobal.com/bbs/board.php?bo_table=tech&wr_id=136
