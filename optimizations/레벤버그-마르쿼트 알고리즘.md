---
layout: page
title: 레벤버그-마르쿼트 알고리즘
permalink: /optimizations/레벤버그-마르쿼트 알고리즘
---
...
- **Marquardt의 개선 (1963):** Donald Marquardt는 Levenberg의 아이디어를 한 단계 더 발전시켰다.27 그는 두 가지 중요한 기여를 했다. 첫째, 그는 
