...
## 1. 정보이론의 초석, 섀넌-하틀리 정리 (Shannon-Hartley Theorem)
...
### 2.1  섀넌-하틀리 정리의 역사적 뿌리: 나이퀴스트와 하틀리의 기여
...
### 3.2  통신 시스템 설계의 근본적 트레이드오프: 대역폭과 SNR의 관계
...
#### 3.4.1 표 2: 대역폭(B)과 SNR(S/N)의 트레이드오프 예시
...
## 4.  이론과 현실의 간극, 그리고 그 극복

### 4.1  섀넌-하틀리 정리의 한계와 실세계 채널 환경
...
### 4.2  현대 통신 기술의 솔루션: 섀넌 한계에 근접하기 위한 노력
...
#### 4.2.1  OFDM(Orthogonal Frequency Division Multiplexing) 기술
...
#### 4.2.2  MIMO(Multiple-Input Multiple-Output) 기술
...
#### 4.2.3 표 3: 현대 통신 기술과 섀넌-하틀리 정리의 관계
...
### 5.1  섀넌-하틀리 정리의 지속적인 중요성과 현대적 의의
...
### 5.2  섀넌의 정보이론에 대한 비판적 시각: '의미'의 한계
