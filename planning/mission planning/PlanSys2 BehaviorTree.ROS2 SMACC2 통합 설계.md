...
### 1.2  전술 계층: 반응형 작업 순서를 위한 BehaviorTree.ROS2
...
### 1.3  반응 계층: 비동기 장치 제어를 위한 SMACC2
...
#### 2.1.2 BT -->> FSM: `RosActionNode`와 SMACC2 클라이언트 패턴
...
### 2.2  상향식 피드백 및 세계 상태 동기화

#### 2.2.1 FSM -->> BT: ROS 액션을 통한 결과 보고
...
#### 2.2.2 FSM/BT -->> HTN: 재계획을 위한 피드백 루프
...
### 3.2  행동 트리의 생명주기: 범위가 지정된 일시적 객체
...
## 5.  고급 아키텍처 고려사항 및 권장사항

### 5.1  시스템 전반의 결함 허용 및 복구
