...
### 2.1  HTN 대 고전적 계획(STRIPS): 절차적 안내 대 원리 기반 발견
...
### 2.2  HTN 대 행동 트리(BT): 심의적 계획 대 반응형 제어
