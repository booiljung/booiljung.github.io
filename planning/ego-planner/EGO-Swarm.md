...
## 1. I. EGO-Swarm: 분산형 자율 비행의 새로운 패러다임

### 1.1. 서론: 복잡하고 미지의 환경에서의 군집 비행 문제 정의
...
### 1.1  EGO-Swarm 솔루션: 분산, 비동기, 온보드 처리의 핵심 원칙
