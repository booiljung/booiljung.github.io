...
#### 1.1.3  DDS 에코시스템: 벤더 환경 및 오픈소스 구현
...
### 1.2  결정론적 네트워크: 항공전자 전이중 스위치 이더넷(AFDX) 심층 분석

#### 1.2.1  아키텍처 원칙: 안전 필수, 결정론적 이더넷을 위한 ARINC 664
...
#### 3.1.3  시너지의 힘: DDS-over-TSN 아키텍처
