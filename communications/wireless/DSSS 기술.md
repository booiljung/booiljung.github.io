...
## 2.  DSSS의 이론적 기반과 수학적 모델링

### 2.1  섀넌의 채널 용량 정리에 기반한 DSSS의 정당성
...
### 3.2  PN 부호의 생성: 선형 궤환 시프트 레지스터(LFSR)
...
#### 5.1.3  근원 문제(Near-Far Problem)와 전력 제어
...
#### 5.2.1  C/A 코드 (Coarse/Acquisition Code) 생성
...
### 5.3  무선 근거리 통신망 (WLAN: IEEE 802.11b)
...
### 6.1  타 기술(OFDM 등)과의 융합 및 향후 발전 방향 전망
