...
## 1.  현대 로봇공학에서 DDS의 역할: 소프트웨어 레벨의 분산화
...
## 2.  EtherCAT의 역할: 하드웨어 인터페이스의 결정론과 성능
...
### 3.2 B. 레벨 2: 핫 스탠바이를 이용한 마스터 이중화
...
## 4.  통합 시스템 아키텍처: DDS와 EtherCAT의 결합
