...
### 2.4 DDS: 단순한 통신 프로토콜을 넘어선 통합 패브릭
...
## 3.  EtherCAT의 역할: 하드웨어 인터페이스의 결정론과 성능
...
### 4.2 B. 레벨 2: 핫 스탠바이를 이용한 마스터 이중화
...
### 4.3 C. 레벨 3: 컨트롤러 이중화를 통한 포괄적인 결함 허용
...
## 5.  통합 시스템 아키텍처: DDS와 EtherCAT의 결합
...
### 6.1 A. Safety over EtherCAT (FSoE)를 통한 기능 안전
