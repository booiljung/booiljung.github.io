...
### 0.1 연합형 아키텍처에서 통합형 아키텍처로의 패러다임 전환
...
## 1. AFDX의 기술 아키텍처 (ARINC 664 Part 7)
...
### 2.1 AFDX 대 레거시 데이터버스 (ARINC 429 & MIL-STD-1553)
...
### 2.2 AFDX 대 차세대 결정론적 이더넷 표준 (TTEthernet & TSN)
...
### 3.3 인증의 관문: DO-254, DO-178C, 그리고 A(M)C 20-193 (CAST-32A)
