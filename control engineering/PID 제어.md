...
적분 제어는 시간에 따라 오차를 계속해서 더해 나간다(적분). 수학적으로 적분항의 출력은 시간 0부터 현재 시간 $t$까지의 오차 $e(τ)$를 적분한 값에 적분 이득(Integral Gain) $Ki$를 곱하여 결정된다.2
$$
...
### 6.3  로보틱스: 다관절 로봇 팔의 조인트(Joint) 제어
