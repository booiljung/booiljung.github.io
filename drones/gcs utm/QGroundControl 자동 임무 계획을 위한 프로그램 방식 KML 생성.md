...
## 3.  Python을 이용한 프로그래밍 방식의 KML 생성
...
### 3.2 QGC 임무 계획을 위한 주요 `simplekml` 함수
...
### 3.4 코드 구현 2: Corridor Scan 임무용 LineString 생성
...
## 4.  QGroundControl 가져오기 엔진: 동작 및 제한 사항
...
## 5.  엔드-투-엔드 워크플로우: 사용자 정의 소프트웨어에서 기체 업로드까지
...
### 5.2 단계: 프로그래밍 방식의 KML 생성 (자동화된 작업)
