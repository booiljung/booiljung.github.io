...
## 4.  파이썬 생태계: 코드 생성, 빌드 스크립팅, 그리고 분석
...
### 4.2  v1.15의 `requirements.txt` 해부
...
### 5.2  ARM 크로스 컴파일러: `gcc-arm-none-eabi`
...
## 6.  시뮬레이션 환경: 소프트웨어 인 더 루프(SITL) 활성화
