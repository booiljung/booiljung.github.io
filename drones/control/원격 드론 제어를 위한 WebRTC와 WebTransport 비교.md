...
### 2.2  NAT Traversal: ICE, STUN, TURN의 현실
...
## 3.  기술 심층 분석: WebTransport

### 3.1  아키텍처: 클라이언트-서버와 QUIC 혁명
...
### 5.4  연결 이동성: ICE Restart vs. Connection Migration
...
### 5.6 Table 1: WebRTC vs. WebTransport - 드론 제어를 위한 기능 비교
...
### 6.2  시나리오 2: 순수 WebTransport 아키텍처
