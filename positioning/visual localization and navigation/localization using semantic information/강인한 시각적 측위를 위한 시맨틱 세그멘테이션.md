...
### 1.1 기하학적 측위에서 시맨틱 측위로의 패러다임 전환
...
### 1.2 시맨틱 환경 정의: 시맨틱, 인스턴스, 파놉틱 세그멘테이션
