...
### 2.1 극심한 시점 변화(Viewpoint Variation)로 인한 도메인 격차
...
### 3.3 카메라 자세 추정의 수학적 원리: Homography 기반 접근법
...
### 4.1 A. 기본 파이프라인과 샴 네트워크 (Fundamental Pipeline and Siamese Networks)
