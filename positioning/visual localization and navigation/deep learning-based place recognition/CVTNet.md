...
## 1. II. LiDAR 데이터 표현 및 처리: CVTNet의 접근 방식
...
## 3. IV. 트랜스포머 기술의 이해: Deformable Transformer와 CVTNet의 관계
