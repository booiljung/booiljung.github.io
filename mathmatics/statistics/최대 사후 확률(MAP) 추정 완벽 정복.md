...
## 3.  기준점: 최대 우도 추정 (Maximum Likelihood Estimation, MLE)
...
## 4.  베이즈주의적 추정: 최대 사후 확률 (Maximum a Posteriori, MAP)
