...
### 0.2 핵심 기능: 자원 관리, 인터페이스 제공, 시스템 보호
...
### 0.3 커널 아키텍처의 이해: 모놀리식 커널과 마이크로커널
...
#### 1.1.2 창의적 작업과 개발 환경의 강자: Apple macOS
...
#### 1.1.4 비교 분석: UI/UX, 파일 시스템, 보안 모델, 소프트웨어 생태계
...
#### 2.1.2 Microsoft 생태계와의 통합: Windows Server
...
#### 2.1.3 선택 기준 분석: 비용, 안정성, 보안, 성능, 애플리케이션 호환성
...
#### 2.2.1 시간 결정성(Determinism)의 중요성
...
#### 2.2.3 사례 연구 1: 항공우주 및 국방 분야의 VxWorks
...
#### 2.2.4 사례 연구 2: 자동차 기능 안전(ISO 26262)과 QNX
...
#### 2.3.2 맞춤형 임베디드 리눅스 구축 프레임워크: Yocto Project
...
#### 2.4.2 대규모 온라인 트랜잭션 처리(OLTP) 아키텍처: CICS와 IMS
...
#### 2.5.2 주요 배포판 비교: Red Hat Enterprise Linux vs. SUSE Linux Enterprise
...
#### 3.2.2 GPU 자원 관리 및 스케줄링: OS 커널 연구 동향과 NVIDIA MIG 기술
...
#### 3.2.3 Kubernetes 환경에서의 GPU 스케줄링 확장 메커니즘
...
29. 윈도우(Window) 대신 리눅스(Linux) 에 서버를 설치하는 이유 - 8ugust의 개발일기, 8월 16, 2025에 액세스, https://8ugust-dev.tistory.com/2
...
63. Chapter 1: Introduction, 8월 16, 2025에 액세스, https://www.microfocus.com/documentation/MainframeExpress/mx31/igarch.htm
...
92. Schedule GPUs | Kubernetes, 8월 16, 2025에 액세스, https://kubernetes.io/docs/tasks/manage-gpus/scheduling-gpus/
